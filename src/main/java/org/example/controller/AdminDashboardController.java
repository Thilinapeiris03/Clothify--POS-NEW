...
public class AdminDashboardController implements Initializable {
    ...
    @FXML // fx:id="btnRegistration"
    private JFXButton btnRegistration; // Value injected by FXMLLoader

    @FXML
    void btnEmployeesOnAction(ActionEvent event) {
        Stage window = (Stage) ((Node)event.getSource()).getScene().getWindow();
        try {
            window.setScene(new Scene(FXMLLoader.load(getClass().getResource("/view/EmployeeDetail.fxmlSupplierDetail"))));
        } catch (IOException e) {
    ...
    void btnRegistrationOnAction(ActionEvent event) {
        Stage window = (Stage) ((Node)event.getSource()).getScene().getWindow();
        try {
            window.setScene(new Scene(FXMLLoader.load(getClass().getResource("/view/RegisterForm.fxml"))));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        window.show();
